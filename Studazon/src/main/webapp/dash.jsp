    ...
    <div class="listingCard-row">
        ...
        <c:forEach var="book" items="${books}">
            <div class="listingCard-column">
                <div class="listingCard" onclick="changeModal.call(this)" data-title="${book.title}"
                     data-author="${book.author}" data-isbn="${book.ISBN}"
                     data-image="${Base64.getEncoder().encodeToString(book.imageUrl)}"
                     data-condition="${book.book_condition}" data-price="${book.price}"
    ...
    <div class="modal_content">
        ...
        <div class="modal-masterContainer">
            ...
            <div class="modal-condCommentsSend">
                ...
                <p id="view-condition" class="modal-condComments-content">Practically new</p>
